        ...
        for batch_idx, (input, target) in enumerate(loader):
            ...
            if args.local_rank == 0 and (last_batch or batch_idx % args.log_interval == 0):
                ...
                _logger.info(
                    ...
                    'Acc@1 Adjoined: {top1_adjoint.val:>7.4f} ({top1_adjoint.avg:>7.4f})  '
                    'Acc@5 Adjoined: {top5_adjoint.val:>7.4f} ({top5_adjoint.avg:>7.4f})'.format(
                        log_name, batch_idx, last_idx, batch_time=batch_time_m,
                        loss=losses_m, top1=top1_m, top5=top5_m, top1_adjoint=top1_adjoint_m, top5_adjoint=top5_adjoint_m))

        metrics = OrderedDict(
            [('loss', losses_m.avg), ('top1', top1_m.avg), ('top5', top5_m.avg), ('top1_adjoined', top1_adjoint_m.avg), ('top5_adjoined', top5_adjoint_m.avg)])
