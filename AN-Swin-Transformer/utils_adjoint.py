...
def load_checkpoint(config, model, optimizer, lr_scheduler, loss_scaler, logger):
	...
	if not config.EVAL_MODE and 'optimizer' in checkpoint and 'lr_scheduler' in checkpoint and 'epoch' in checkpoint:
		...
		if 'max_adjoint_accuracy' in checkpoint:
			max_adjoint_accuracy = checkpoint['max_adjoint_accuracy']

	del checkpoint
	torch.cuda.empty_cache()
	return max_accuracy, max_adjoint_accuracy
...
def save_checkpoint(config, epoch, model, max_accuracy, max_adjoint_accuracy, optimizer, lr_scheduler, loss_scaler, logger):
	save_state = {'model': model.state_dict(),
				  'optimizer': optimizer.state_dict(),
				  'lr_scheduler': lr_scheduler.state_dict(),
				  'max_accuracy': max_accuracy,
				  'max_adjoint_accuracy': max_adjoint_accuracy,
